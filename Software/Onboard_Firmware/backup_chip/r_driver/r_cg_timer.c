...
void R_TAU0_Create(void)
{
    ...
    /* Channel 1 used as delay count function */
    ...
    NFEN1 &= (uint8_t)~_04_TAU_CH2_NOISE_ON;    /* disable using noise filter of TI02 pin input signal */
    /* Set TI01 pin */
    PM1 |= 0x40U;
    /* Set TI02 pin */
    PM1 |= 0x80U;
